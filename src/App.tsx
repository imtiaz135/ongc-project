...
function App() {
  ...
  useEffect(() => {
    const handleMouseMove = (e: MouseEvent) => {
      ...
      // Constrain between 40% and 80% to ensure both panels remain usable
  ...
  return (
    <div className="h-screen flex flex-col bg-gray-50">
      ...
      {!file ? (
        ...
        <div className="flex-1 flex overflow-hidden" data-split-container>
          {/* Left: PDF Viewer */}
          <div style={{ width: `${splitPosition}%` }} className="border-r border-gray-200 bg-gray-100 transition-all duration-0">
